  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-[hsl(165,60%,40%)] to-[hsl(200,70%,50%)] text-white shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-300",
        "hero-outline": "border-2 border-primary/30 bg-transparent text-foreground hover:bg-primary/10 hover:border-primary/50 active:scale-[0.98]",
        income: "bg-gradient-to-r from-[hsl(145,60%,42%)] to-[hsl(160,55%,48%)] text-white shadow-md hover:shadow-lg active:scale-[0.98]",
        expense: "bg-gradient-to-r from-[hsl(0,72%,51%)] to-[hsl(15,70%,55%)] text-white shadow-md hover:shadow-lg active:scale-[0.98]",
      },
      size: {
